...
func HandleGetL2TPClient(c echo.Context) error {
	...
	response := L2TPClientResponse{
		...
		Status:            l2tpClient.Status,
		Uptime:            l2tpClient.Uptime,
		Encoding:          l2tpClient.Encoding,
		MTU:               l2tpClient.MTU,
		LocalAddress:      l2tpClient.LocalAddress,
		RemoteAddress:     l2tpClient.RemoteAddress,
		LocalIPv6Address:  l2tpClient.LocalIPv6Address,
		RemoteIPv6Address: l2tpClient.RemoteIPv6Address,
	}
