...
var appliedCatalog = map[string]sectionProbe{
	...
	"firewall-filter": {"/ip/firewall/filter", map[string]string{"comment": "Block Open Recursive DNS"}, 2},
	"nat":             {"/ip/firewall/nat", map[string]string{"comment": "MASQUERADE the traffic go to WAN Interfaces"}, 1},
