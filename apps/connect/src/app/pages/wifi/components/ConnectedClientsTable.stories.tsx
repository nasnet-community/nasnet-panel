...
export const Default: Story = {
  ...
  args: {
    clients: [
      makeClient({ id: 'c1', macAddress: 'AA:BB:CC:DD:EE:01', signalStrength: -45, interface: 'wlan1', uptime: '5h 10m', rxBytes: 209_715_200, txBytes: 52_428_800 }),
      makeClient({ id: 'c2', macAddress: 'AA:BB:CC:DD:EE:02', signalStrength: -58, interface: 'wlan2', txRate: 300, rxRate: 150, uptime: '1h 44m', rxBytes: 31_457_280, txBytes: 10_485_760 }),
      makeClient({ id: 'c3', macAddress: 'AA:BB:CC:DD:EE:03', signalStrength: -63, interface: 'wlan1', txRate: 72, rxRate: 36, uptime: '12m', rxBytes: 5_242_880, txBytes: 1_048_576 }),
    ],
    isLoading: false,
  },
  parameters: {
...
export const ExcellentSignal: Story = {
  ...
  args: {
    clients: [
      makeClient({ id: 'c1', macAddress: 'AA:BB:CC:DD:EE:01', signalStrength: -42, uptime: '8h 05m', rxBytes: 524_288_000, txBytes: 104_857_600 }),
      makeClient({ id: 'c2', macAddress: 'BB:CC:DD:EE:FF:00', signalStrength: -47, uptime: '4h 30m', txRate: 600, rxRate: 300, rxBytes: 157_286_400, txBytes: 31_457_280 }),
    ],
    isLoading: false,
  },
  parameters: {
...
export const MixedSignalLevels: Story = {
  ...
  args: {
    clients: [
      makeClient({ id: 'c1', macAddress: 'AA:BB:CC:DD:EE:01', signalStrength: -48, interface: 'wlan2', uptime: '6h 00m' }),
      makeClient({ id: 'c2', macAddress: 'AA:BB:CC:DD:EE:02', signalStrength: -62, interface: 'wlan1', uptime: '2h 15m' }),
      makeClient({ id: 'c3', macAddress: 'AA:BB:CC:DD:EE:03', signalStrength: -71, interface: 'wlan1', txRate: 54, rxRate: 27, uptime: '35m' }),
      makeClient({ id: 'c4', macAddress: 'AA:BB:CC:DD:EE:04', signalStrength: -85, interface: 'wlan1', txRate: 12, rxRate: 6, uptime: '3m', rxBytes: 524_288, txBytes: 131_072 }),
    ],
    isLoading: false,
  },
  parameters: {
...
export const Loading: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Animated pulse skeleton rendered while client data is being fetched from the router.',
      },
    },
  },
};
...
export const SingleClient: Story = {
  ...
  args: {
    clients: [
      makeClient({ id: 'c1', macAddress: 'DE:AD:BE:EF:CA:FE', signalStrength: -55, interface: 'wlan1', uptime: '1h 01m' }),
    ],
    isLoading: false,
  },
  parameters: {
