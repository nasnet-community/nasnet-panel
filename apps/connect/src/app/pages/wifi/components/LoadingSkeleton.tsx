  ...
  return (
    <div className="space-y-6 animate-pulse">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {[1, 2].map((i) => (
          <div key={i} className="bg-card rounded-card-sm border border-border shadow-sm p-component-md">
      ...
      <div className="bg-card rounded-card-sm border border-border shadow-sm p-component-md">
