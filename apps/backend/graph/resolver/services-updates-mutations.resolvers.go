...
func (r *mutationResolver) UpdateInstance(ctx context.Context, routerID string, instanceID string) (*model.UpdateResult, error) {
	...
	if r.UpdateService == nil {
		return nil, apperrors.NewProtocolError(apperrors.CodeCommandFailed, "update service not initialized", "graphql")
	}
	...
	if err != nil {
		return nil, apperrors.Wrap(err, apperrors.CodeProtocolError, apperrors.CategoryProtocol, "failed to check for update")
	}
