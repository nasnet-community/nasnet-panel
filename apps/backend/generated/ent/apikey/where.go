...
// AllowedRoutersIsNil applies the IsNil predicate on the "allowed_routers" field.
func AllowedRoutersIsNil() predicate.APIKey {
	return predicate.APIKey(sql.FieldIsNull(FieldAllowedRouters))
}

// AllowedRoutersNotNil applies the NotNil predicate on the "allowed_routers" field.
func AllowedRoutersNotNil() predicate.APIKey {
	return predicate.APIKey(sql.FieldNotNull(FieldAllowedRouters))
}
