...
type Resolver struct {
	...
	ScheduleService *orchestrator.ScheduleService

	// ScheduleEvaluator evaluates schedule time windows (NAS-8.21).
	ScheduleEvaluator *orchestrator.ScheduleEvaluator
	...
	// ConfigService handles service configuration generation and management (NAS-8.5).
