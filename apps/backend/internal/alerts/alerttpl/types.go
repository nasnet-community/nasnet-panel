// Package alerttpl provides alert rule template management.
package alerttpl
...
// AlertRuleTemplateVariable represents a configurable parameter.
...
// TemplateCondition represents a condition in a template.
