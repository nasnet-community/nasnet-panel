...
// Note: TestChannelHasSubject and TestStripHTMLTags are tested as part of the
// full template_service_test.go since they depend on template_service.go functions
