...
// CleanCommandText removes extra whitespace and backslash patterns. //nolint:gocyclo // command text cleaning complexity
...
func ExtractPath(text string) (path, rest string) {
...
func SplitCommandParts(text string) []string { //nolint:gocyclo // command splitting inherently complex
	var parts []string
...
func ParseFindQuery(parts []string) (query *FindQuery, endIdx int) {
