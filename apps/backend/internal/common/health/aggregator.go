...
// Aggregator runs multiple probes and aggregates their results into a AggregatedStatus.
...
func (a *Aggregator) Check(ctx context.Context) AggregatedStatus {
	a.mu.RLock()
