...
func (dm *DependencyManager) detectCycle(ctx context.Context, toID, fromID string) (bool, []string) {
...
func (dm *DependencyManager) dfsDetectCycle(ctx context.Context, current, target string, visited map[string]bool, path []string) (bool, []string) {
...
func (dm *DependencyManager) DetectCycle(ctx context.Context, fromID, toID string) (bool, []string) {
	dm.mu.RLock()
	defer dm.mu.RUnlock()
