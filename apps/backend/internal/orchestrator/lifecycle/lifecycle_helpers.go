...
func (im *InstanceManager) canTransition(from, to InstanceStatus) bool {
...
func (im *InstanceManager) emitStateChangeEvent(ctx context.Context, instanceID, fromStatus, toStatus string) {
