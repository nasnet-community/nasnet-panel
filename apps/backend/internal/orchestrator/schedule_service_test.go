...
func setupTestScheduleService(t *testing.T) (*ScheduleService, *events.MockEventBus, func()) {
	t.Helper()
	...
	mockBus := events.NewMockEventBus()
...
func (m *MockScheduleEvaluator) Evaluate(ctx context.Context) error {
	m.EvaluateCalls++
	return nil
}

func (m *MockScheduleEvaluator) Start(ctx context.Context) error {
	return nil
}
...
func TestCreateSchedule(t *testing.T) {
	...
	t.Run("successful creation", func(t *testing.T) {
		...
		assert.Equal(t, "schedule.created", events[0].GetType())

		// Verify scheduler was triggered
		mockScheduler := svc.scheduler.(*MockScheduleEvaluator)
	...
	t.Run("disabled schedule does not trigger evaluation", func(t *testing.T) {
		mockScheduler := svc.scheduler.(*MockScheduleEvaluator)
		initialCalls := mockScheduler.EvaluateCalls
		...
		assert.Equal(t, initialCalls, mockScheduler.EvaluateCalls)
	})
}
...
func TestUpdateSchedule(t *testing.T) {
	...
	t.Run("successful update", func(t *testing.T) {
		...
		events := mockBus.GetPublishedEvents()
		assert.Len(t, events, 1)
		assert.Equal(t, "schedule.updated", events[0].GetType())
	})
...
func TestDeleteSchedule(t *testing.T) {
	...
	t.Run("successful deletion", func(t *testing.T) {
		...
		events := mockBus.GetPublishedEvents()
		assert.Len(t, events, 1)
		assert.Equal(t, "schedule.deleted", events[0].GetType())
	})
