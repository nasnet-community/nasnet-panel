...
```
/container/add file=disk1/nasnet-panel-dev-arm64.tar interface=veth1 root-dir=disk1/images/nasnet-panel name=nasnet-panel start-on-boot=yes logging=yes
```
...
/container/add remote-image=nasnet-community/nasnet-panel:dev interface=veth1 root-dir=disk1/images/nasnet-panel name=nasnet-panel start-on-boot=yes logging=yes
```
