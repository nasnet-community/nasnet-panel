 ...
 */
export declare const usePortKnockStore: import("zustand").UseBoundStore<Omit<import("zustand").StoreApi<PortKnockUIState>, "persist"> & {
    persist: {
        setOptions: (options: Partial<import("zustand/middleware").PersistOptions<PortKnockUIState, unknown>>) => void;
        clearStorage: () => void;
        rehydrate: () => Promise<void> | void;
        hasHydrated: () => boolean;
        onHydrate: (fn: (state: PortKnockUIState) => void) => () => void;
        onFinishHydration: (fn: (state: PortKnockUIState) => void) => () => void;
        getOptions: () => Partial<import("zustand/middleware").PersistOptions<PortKnockUIState, unknown>>;
    };
}>;
