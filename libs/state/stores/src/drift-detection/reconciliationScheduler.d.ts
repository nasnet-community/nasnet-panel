 ...
 */
export declare function getDefaultScheduler(options?: ReconciliationSchedulerOptions): ReconciliationScheduler;
/**
 * Initialize the default scheduler
 */
export declare function initializeScheduler(options: ReconciliationSchedulerOptions): ReconciliationScheduler;
/**
