 ...
 */
export declare const RUNTIME_ONLY_FIELDS: readonly ["bytesIn", "bytesOut", "packetsIn", "packetsOut", "txRate", "rxRate", "lastHandshake", "lastSeen", "connectedSince", "lastConnected", "uptime", "currentPeers", "activeConnections", "cpuLoad", "memoryUsage", "lastUpdated", "lastModified", "lastAccessed", "health", "status", "isRunning", "errorCount"];
...
export type DriftResolutionAction = (typeof DriftResolutionAction)[keyof typeof DriftResolutionAction];
/**
