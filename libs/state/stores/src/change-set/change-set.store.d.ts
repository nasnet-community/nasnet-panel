import type { ChangeSet, ChangeSetItem, ChangeSetStatus, ChangeSetSummary, ChangeSetItemStatus } from '@nasnet/core/types';
/**
...
export interface ChangeSetActions {
     ...
     */
    addItem: (changeSetId: string, item: Omit<ChangeSetItem, 'id' | 'status' | 'applyOrder' | 'applyStartedAt' | 'applyCompletedAt' | 'confirmedState' | 'error'>) => string;
    /**
     * Update an item in a change set
     */
    updateItem: (changeSetId: string, itemId: string, updates: Partial<Pick<ChangeSetItem, 'name' | 'description' | 'configuration' | 'dependencies'>>) => void;
    /**
     ...
     * Update item status
     */
    updateItemStatus: (changeSetId: string, itemId: string, status: ChangeSetItemStatus, error?: string) => void;
    /**
 ...
 * ```
 */
export declare const useChangeSetStore: import("zustand").UseBoundStore<Omit<Omit<import("zustand").StoreApi<ChangeSetState & ChangeSetActions>, "setState"> & {
    setState<A extends string | {
        type: string;
    }>(partial: (ChangeSetState & ChangeSetActions) | Partial<ChangeSetState & ChangeSetActions> | ((state: ChangeSetState & ChangeSetActions) => (ChangeSetState & ChangeSetActions) | Partial<ChangeSetState & ChangeSetActions>), replace?: boolean | undefined, action?: A | undefined): void;
}, "persist"> & {
    persist: {
        setOptions: (options: Partial<import("zustand/middleware").PersistOptions<ChangeSetState & ChangeSetActions, {
            changeSets: {
        ...
        getOptions: () => Partial<import("zustand/middleware").PersistOptions<ChangeSetState & ChangeSetActions, {
            changeSets: {
                [k: string]: ChangeSet<Record<string, unknown>>;
            };
            activeChangeSetId: string | null;
 ...
 */
export declare const selectActiveChangeSet: (state: ChangeSetState) => ChangeSet<Record<string, unknown>> | null;
/**
 * Select all change sets for a router
 */
export declare const createSelectChangeSetsForRouter: (routerId: string) => (state: ChangeSetState) => ChangeSet<Record<string, unknown>>[];
/**
 * Select draft change sets for a router
 */
export declare const createSelectDraftChangeSets: (routerId: string) => (state: ChangeSetState) => ChangeSet<Record<string, unknown>>[];
/**
 * Select applying change sets
 */
export declare const selectApplyingChangeSets: (state: ChangeSetState) => ChangeSet<Record<string, unknown>>[];
/**
 ...
 */
export declare const subscribeChangeSetState: (listener: (state: ChangeSetState & ChangeSetActions, prevState: ChangeSetState & ChangeSetActions) => void) => () => void;
