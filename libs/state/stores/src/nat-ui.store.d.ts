 ...
 */
export declare const useNATUIStore: import('zustand').UseBoundStore<
  Omit<import('zustand').StoreApi<NATUIState>, 'persist'> & {
    persist: {
      setOptions: (
        options: Partial<import('zustand/middleware').PersistOptions<NATUIState, unknown>>
      ) => void;
      clearStorage: () => void;
