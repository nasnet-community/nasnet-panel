 ...
 */
export declare const useMangleUIStore: import("zustand").UseBoundStore<Omit<import("zustand").StoreApi<MangleUIState>, "persist"> & {
    persist: {
        setOptions: (options: Partial<import("zustand/middleware").PersistOptions<MangleUIState, unknown>>) => void;
        clearStorage: () => void;
        rehydrate: () => Promise<void> | void;
        hasHydrated: () => boolean;
        onHydrate: (fn: (state: MangleUIState) => void) => () => void;
        onFinishHydration: (fn: (state: MangleUIState) => void) => () => void;
        getOptions: () => Partial<import("zustand/middleware").PersistOptions<MangleUIState, unknown>>;
    };
}>;
