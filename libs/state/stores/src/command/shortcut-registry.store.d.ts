 ...
 * ```
 */
export declare const useShortcutRegistry: import('zustand').UseBoundStore<
  Omit<import('zustand').StoreApi<ShortcutRegistryState & ShortcutRegistryActions>, 'setState'> & {
    setState<
      A extends
        | string
        | {
    ...
    >(
      partial:
        ...
        | Partial<ShortcutRegistryState & ShortcutRegistryActions>
        | ((
            state: ShortcutRegistryState & ShortcutRegistryActions
          ) =>
            | (ShortcutRegistryState & ShortcutRegistryActions)
            | Partial<ShortcutRegistryState & ShortcutRegistryActions>),
 ...
 */
export declare const getShortcutRegistryState: () => ShortcutRegistryState &
  ShortcutRegistryActions;
/**
 * Subscribe to shortcut registry changes outside of React
 */
export declare const subscribeShortcutRegistry: (
  listener: (
    state: ShortcutRegistryState & ShortcutRegistryActions,
    prevState: ShortcutRegistryState & ShortcutRegistryActions
  ) => void
) => () => void;
/**
 * Group shortcuts by category for display
 */
export declare function groupShortcutsByCategory(
  shortcuts: Shortcut[]
