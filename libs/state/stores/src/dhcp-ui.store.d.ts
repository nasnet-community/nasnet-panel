 ...
 */
export declare const useDHCPUIStore: import("zustand").UseBoundStore<Omit<import("zustand").StoreApi<DHCPUIState>, "persist"> & {
    persist: {
        setOptions: (options: Partial<import("zustand/middleware").PersistOptions<DHCPUIState, unknown>>) => void;
        clearStorage: () => void;
