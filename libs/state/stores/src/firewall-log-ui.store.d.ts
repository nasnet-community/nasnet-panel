 ...
 */
export declare const useFirewallLogStore: import("zustand").UseBoundStore<Omit<import("zustand").StoreApi<FirewallLogUIState>, "persist"> & {
    persist: {
        setOptions: (options: Partial<import("zustand/middleware").PersistOptions<FirewallLogUIState, unknown>>) => void;
        clearStorage: () => void;
        rehydrate: () => Promise<void> | void;
        hasHydrated: () => boolean;
        onHydrate: (fn: (state: FirewallLogUIState) => void) => () => void;
        onFinishHydration: (fn: (state: FirewallLogUIState) => void) => () => void;
        getOptions: () => Partial<import("zustand/middleware").PersistOptions<FirewallLogUIState, unknown>>;
    };
}>;
/**
