 ...
 */
export declare const useServiceUIStore: import('zustand').UseBoundStore<
  Omit<import('zustand').StoreApi<ServiceUIState>, 'persist'> & {
    persist: {
      setOptions: (
        options: Partial<import('zustand/middleware').PersistOptions<ServiceUIState, unknown>>
      ) => void;
      clearStorage: () => void;
      ...
      getOptions: () => Partial<
        import('zustand/middleware').PersistOptions<ServiceUIState, unknown>
      >;
    };
  }
>;
