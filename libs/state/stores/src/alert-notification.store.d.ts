 ...
 */
export declare const useAlertNotificationStore: import('zustand').UseBoundStore<
  Omit<import('zustand').StoreApi<AlertNotificationState>, 'persist'> & {
    persist: {
      setOptions: (
        options: Partial<
          import('zustand/middleware').PersistOptions<AlertNotificationState, unknown>
        >
      ) => void;
      clearStorage: () => void;
