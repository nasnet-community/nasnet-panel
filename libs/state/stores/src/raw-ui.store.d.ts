 ...
 */
export declare const useRawUIStore: import('zustand').UseBoundStore<
  Omit<import('zustand').StoreApi<RawUIState>, 'persist'> & {
    persist: {
      setOptions: (
        options: Partial<import('zustand/middleware').PersistOptions<RawUIState, unknown>>
      ) => void;
      clearStorage: () => void;
