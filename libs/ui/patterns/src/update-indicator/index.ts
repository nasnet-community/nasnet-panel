/**
 * UpdateIndicator Pattern - Service Update Indicator (NAS-8.7)
 * Layer 2 Pattern Component with Headless + Platform Presenters
 */

export { UpdateIndicator } from './UpdateIndicator';
export { UpdateIndicatorMobile } from './UpdateIndicatorMobile';
export { UpdateIndicatorDesktop } from './UpdateIndicatorDesktop';
