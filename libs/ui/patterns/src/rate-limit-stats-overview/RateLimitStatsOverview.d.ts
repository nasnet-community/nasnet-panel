 ...
 * ```
 */
export declare const RateLimitStatsOverview: import("react").NamedExoticComponent<RateLimitStatsOverviewProps>;
export { RateLimitStatsOverviewDesktop, RateLimitStatsOverviewMobile };
export type { RateLimitStatsOverviewProps };
//# sourceMappingURL=RateLimitStatsOverview.d.ts.map