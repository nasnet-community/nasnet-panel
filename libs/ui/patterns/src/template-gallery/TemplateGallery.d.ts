 ...
 */
declare function TemplateGalleryComponent(props: TemplateGalleryProps): import("react/jsx-runtime").JSX.Element;
export declare const TemplateGallery: import("react").MemoExoticComponent<typeof TemplateGalleryComponent>;
export {};
