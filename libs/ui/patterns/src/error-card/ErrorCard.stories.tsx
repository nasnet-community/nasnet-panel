...
export const Default: Story = {
  args: {
    ...
    description: 'There was a problem retrieving the configuration from the router. The data shown may be stale.',
    errorCode: 'R100',
...
export const Warning: Story = {
  args: {
    ...
    description: 'The running config differs from the last saved config. Changes may have been applied outside this app.',
...
export const NotFound: Story = {
  args: {
    ...
    description: 'The requested firewall rule no longer exists. It may have been deleted by another administrator.',
    errorCode: 'R404',
...
export const FullFeatured: Story = {
  args: {
    ...
    description: 'The router at 192.168.88.1 cannot be reached. This may be due to a network interruption or the router being offline.',
    errorCode: 'N300',
    technicalMessage: 'Error: connect ECONNREFUSED 192.168.88.1:8728\n  at TCPConnectWrap.afterConnect [as oncomplete] (node:net:1494:16)',
    stackTrace: 'Error: connect ECONNREFUSED 192.168.88.1:8728\n    at Object.exports.createConnection (/app/lib/net.js:49:10)\n    at RouterClient.connect (/app/router-client.js:127:12)',
    onRetry: () => console.log('Retry clicked'),
