 ...
 * ```
 */
export declare function useResourceCard<T extends BaseResource>(props: ResourceCardProps<T>): UseResourceCardReturn;
//# sourceMappingURL=useResourceCard.d.ts.map