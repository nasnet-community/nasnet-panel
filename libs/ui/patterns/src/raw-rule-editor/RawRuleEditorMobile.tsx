...
import { Zap, Shield, Settings, Info, Trash2 } from 'lucide-react';
  ...
  return (
    <FormProvider {...form}>
      ...
      >
        ...
        >
          <SheetHeader>
            <SheetTitle>{mode === 'create' ? 'Create RAW Rule' : 'Edit RAW Rule'}</SheetTitle>
            <SheetDescription>
              ...
              <CardContent className="p-4">
                <div className="flex items-start gap-2">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-info mb-1 text-xs font-medium">Preview</p>
            ...
            {showNotrackTip && (
              <Alert variant="warning">
                ...
                <AlertDescription className="text-sm">
                  Notrack skips connection tracking for performance. Use for trusted high-bandwidth
                  traffic.
                </AlertDescription>
              </Alert>
            )}
