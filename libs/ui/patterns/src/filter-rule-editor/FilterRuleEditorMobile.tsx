...
import { Network, Settings, Info, Trash2 } from 'lucide-react';
import { Controller, FormProvider } from 'react-hook-form';

import { cn } from '@nasnet/ui/utils';

import { FilterChainSchema, FilterActionSchema, ConnectionStateSchema } from '@nasnet/core/types';
import {
  Sheet,
  SheetContent,
  SheetHeader,
  ...
  return (
    <FormProvider {...form}>
      ...
      >
        ...
        >
          <SheetHeader>
            <SheetTitle>{mode === 'create' ? 'Create Filter Rule' : 'Edit Filter Rule'}</SheetTitle>
            <SheetDescription>Configure firewall rules</SheetDescription>
          </SheetHeader>

          <div className="flex-1 space-y-4 overflow-y-auto pb-20">
            {/* Live Preview */}
            <Card className="p-component-md border-t-category-firewall bg-info/10 border-info/20 border-t-2">
            ...
            {/* Chain and Action */}
            <Card className="p-component-md border-t-category-firewall space-y-4 border-t-2">
            ...
            {/* Traffic Matchers */}
            <Card className="p-component-md space-y-4">
              <h3 className="text-foreground flex items-center gap-2 text-sm font-semibold uppercase tracking-wider">
            ...
            <Card className="p-component-md space-y-4">
              ...
              <label
                htmlFor="filter-disabled-switch"
