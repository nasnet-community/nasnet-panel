...
import { AddressListManagerTablet } from './AddressListManager.tablet';
...
function AddressListManagerComponent(props: AddressListManagerProps) {
  ...
  switch (platform) {
    ...
    case 'tablet':
      return <AddressListManagerTablet {...combinedProps} />;
    case 'desktop':
    default:
...
AddressListManager.displayName = 'AddressListManager';
