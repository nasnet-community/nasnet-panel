 ...
 * ```
 */
export declare function SharedElement({ layoutId, children, className, disabled, ...props }: SharedElementProps): import("react/jsx-runtime").JSX.Element;
 ...
 * ```
 */
export declare function SharedElementRoot({ children, id }: SharedElementRootProps): import("react/jsx-runtime").JSX.Element;
 ...
 * ```
 */
export declare function SharedElementGroup({ children, id }: SharedElementGroupProps): import("react/jsx-runtime").JSX.Element;
 ...
 * ```
 */
export declare function SharedImage({ layoutId, src, alt, className, ...props }: SharedImageProps): import("react/jsx-runtime").JSX.Element;
