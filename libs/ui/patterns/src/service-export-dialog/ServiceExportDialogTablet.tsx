...
export function ServiceExportDialogTablet(props: ServiceExportDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="max-w-xl bg-card border border-border rounded-[var(--semantic-radius-modal)] shadow-[var(--semantic-shadow-modal)] p-6">
        <DialogHeader>
            ...
            <div className="space-y-3">
              ...
              <RadioGroup value={state.options.format} onValueChange={setFormat}>
                <div className="space-y-component-md">
                  ...
                  >
                    <RadioGroupItem value="json" id="format-json-tablet" className="mt-1" />
                    <div className="flex-1">
                      <label htmlFor="format-json-tablet" className="cursor-pointer">
                  ...
                  >
                    <RadioGroupItem value="qr" id="format-qr-tablet" className="mt-1" />
                    <div className="flex-1">
                      <label htmlFor="format-qr-tablet" className="cursor-pointer">
                        <div className="flex items-center gap-2">
            ...
            <div className="space-y-4 rounded-[var(--semantic-radius-input)] border border-border p-component-md bg-muted/30">
              <div className="flex items-center justify-between min-h-[44px]">
                <div className="space-y-0.5 flex-1">
                  <Label htmlFor="redact-secrets-tablet" className="text-base">
                    Redact Secrets
                  </Label>
              ...
              <div className="flex items-center justify-between min-h-[44px]">
                <div className="space-y-0.5 flex-1">
                  <Label htmlFor="include-routing-tablet" className="text-base">
