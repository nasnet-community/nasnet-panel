 ...
 */
export type CollisionStrategy = 'closestCenter' | 'closestCorners' | 'rectIntersection' | 'pointerWithin';
/**
 ...
 */
export type ValidateDropFn<T extends SortableItemData> = (item: T, targetIndex: number, items: T[]) => DropValidationResult | boolean;
/**
 * Reorder event data
 */
