...
export function ConfigPreviewMobile({
  ...
  return (
    <div
      className={cn(
        'bg-card border-border flex flex-col rounded-[var(--semantic-radius-card)] border',
        className
      )}
      role="region"
      aria-label={title}
    >
      {/* Sticky header */}
      <div className="bg-muted border-border sticky top-0 z-10 flex flex-col gap-3 border-b p-4">
        {/* Title row */}
