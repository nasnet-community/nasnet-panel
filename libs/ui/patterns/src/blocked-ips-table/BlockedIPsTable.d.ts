 ...
 */
export declare function BlockedIPsTable(props: BlockedIPsTableProps): import("react/jsx-runtime").JSX.Element;
export declare namespace BlockedIPsTable {
    var displayName: string;
}
//# sourceMappingURL=BlockedIPsTable.d.ts.map