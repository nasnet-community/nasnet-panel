  ...
  'inline-flex items-center rounded-full px-3 py-1 text-xs font-medium ring-1 ring-inset transition-colors',
  {
    variants: {
      variant: {
        ...
        established:
          'bg-success/10 text-success ring-success/20 dark:bg-success/20 dark:text-green-400',
...
const ConnectionStateBadgeBase = React.forwardRef<HTMLSpanElement, ConnectionStateBadgeProps>(
