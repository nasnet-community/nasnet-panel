  ...
  render: function ControlledTabs() {
    ...
    return (
      <div className="flex flex-col items-center gap-4">
        <p className="text-muted-foreground text-sm">Active tab: {value}</p>
        <Tabs
          value={value}
...
export const FullWidth: Story = {
  render: () => (
    ...
    >
      ...
      >
        <h3 className="mb-2 font-medium">Dashboard Overview</h3>
      ...
      <TabsContent
        ...
        className="mt-2 rounded-lg border p-4"
      >
        <h3 className="mb-2 font-medium">Traffic Analytics</h3>
        <p className="text-muted-foreground text-sm">
      ...
      <TabsContent
        ...
        className="mt-2 rounded-lg border p-4"
      >
        <h3 className="mb-2 font-medium">Generated Reports</h3>
        <p className="text-muted-foreground text-sm">
