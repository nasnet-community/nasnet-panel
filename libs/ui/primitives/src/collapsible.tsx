...
const Collapsible = React.memo(
  CollapsiblePrimitive.Root as React.ComponentType<
...
const CollapsibleTrigger = React.memo(
  CollapsiblePrimitive.Trigger as React.ComponentType<
...
const CollapsibleContent = React.memo(
  CollapsiblePrimitive.Content as React.ComponentType<
