...
export const AvatarGroup: Story = {
  render: () => (
    <div className="flex -space-x-2">
      ...
      <Avatar className="border-background border-2">
        <AvatarFallback className="bg-success/20 text-success text-xs font-semibold">
          A3
        </AvatarFallback>
      </Avatar>
      <Avatar className="border-background border-2">
...
export const Desktop: Story = {
  render: () => (
    <div className="flex flex-col gap-6">
      <div>
        <h3 className="mb-3 text-sm font-medium">Standard avatars</h3>
        <div className="flex gap-4">
          <Avatar>
            <AvatarImage
              src="https://github.com/shadcn.png"
      ...
      <div>
        <h3 className="mb-3 text-sm font-medium">Avatar group (overlapping)</h3>
        <div className="flex -space-x-2">
          <Avatar className="border-background border-2">
            <AvatarFallback className="bg-primary/20 text-primary text-xs font-semibold">
              U1
          ...
          <Avatar className="border-background border-2">
            <AvatarFallback className="bg-info/20 text-info text-xs font-semibold">
              U2
            </AvatarFallback>
          </Avatar>
          <Avatar className="border-background border-2">
