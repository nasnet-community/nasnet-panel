  ...
  React.forwardRef<React.ElementRef<typeof SliderPrimitive.Root>, SliderProps>(
    ({ className, ...props }, ref) => (
      ...
      >
        ...
        <SliderPrimitive.Thumb className="border-primary bg-card focus-visible:ring-ring block h-5 w-5 rounded-full border-2 shadow-sm transition-all duration-150 hover:scale-110 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50" />
      </SliderPrimitive.Root>
    )
  )
);
