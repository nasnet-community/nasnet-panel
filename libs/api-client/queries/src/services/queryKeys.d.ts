...
export declare const serviceQueryKeys: {
  ...
  instancesByStatus: (
    routerId: string,
    status?: string
  ) => readonly ['services', 'instances', string, 'status', string | undefined];
  instancesByFeature: (
    routerId: string,
    featureID?: string
  ) => readonly ['services', 'instances', string, 'feature', string | undefined];
  instancesFiltered: (
    routerId: string,
    status?: string,
    featureID?: string
  ...
  instance: (
    routerId: string,
    instanceId: string
  ) => readonly ['services', 'instances', string, string];
  /**
   * Keys for installation progress tracking
   */
  installProgress: (routerId: string) => readonly ['services', 'install-progress', string];
  installProgressByInstance: (
    routerId: string,
    instanceId: string
  ) => readonly ['services', 'install-progress', string, string];
};
