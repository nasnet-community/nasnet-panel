 ...
 * ```
 */
export declare function useServiceAlerts(variables: GetServiceAlertsVariables, options?: {
    pollInterval?: number;
    skip?: boolean;
}): {
    ...
    refetch: (variables?: Partial<GetServiceAlertsVariables> | undefined) => Promise<import("@apollo/client").ApolloQueryResult<GetServiceAlertsResult>>;
};
/**
 ...
 * ```
 */
export declare function useServiceAlertSubscription(variables?: ServiceAlertEventsVariables, enabled?: boolean): {
 ...
 * ```
 */
export declare function useAcknowledgeAlert(): readonly [(options?: import("@apollo/client").MutationFunctionOptions<AcknowledgeAlertResult, AcknowledgeAlertVariables, import("@apollo/client").DefaultContext, import("@apollo/client").ApolloCache<any>> | undefined) => Promise<import("@apollo/client").FetchResult<AcknowledgeAlertResult>>, {
 ...
 * ```
 */
export declare function useAcknowledgeAlerts(): readonly [(options?: import("@apollo/client").MutationFunctionOptions<AcknowledgeAlertsResult, AcknowledgeAlertsVariables, import("@apollo/client").DefaultContext, import("@apollo/client").ApolloCache<any>> | undefined) => Promise<import("@apollo/client").FetchResult<AcknowledgeAlertsResult>>, {
