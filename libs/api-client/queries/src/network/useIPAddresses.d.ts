 ...
 */
export declare function useIPAddresses(
  routerId: string,
  interfaceId?: string
): {
  ipAddresses: any;
 ...
 */
export declare function useIPAddressDetail(
  routerId: string,
  ipAddressId: string
): {
  ipAddress: any;
 ...
 */
export declare function useCheckIPConflict(
  routerId: string,
  address: string,
  interfaceId?: string,
  excludeId?: string,
 ...
 */
export declare function useIPAddressDependencies(
  routerId: string,
  ipAddressId: string,
  enabled?: boolean
): {
