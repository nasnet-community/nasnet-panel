 ...
 */
export declare function useRoutes(routerId: string, options?: UseRoutesOptions): {
    routes: any;
    loading: boolean;
 ...
 */
export declare function useRoute(routerId: string, routeId: string): {
    route: any;
    loading: boolean;
    error: import("@apollo/client").ApolloError | undefined;
    refetch: (variables?: Partial<import("@apollo/client").OperationVariables> | undefined) => Promise<import("@apollo/client").ApolloQueryResult<any>>;
...
export declare function useCreateRoute(): {
    createRoute: (options?: import("@apollo/client").MutationFunctionOptions<any, import("@apollo/client").OperationVariables, import("@apollo/client").DefaultContext, import("@apollo/client").ApolloCache<any>> | undefined) => Promise<import("@apollo/client").FetchResult<any>>;
    result: any;
    loading: boolean;
    error: import("@apollo/client").ApolloError | undefined;
};
...
export declare function useUpdateRoute(): {
    updateRoute: (options?: import("@apollo/client").MutationFunctionOptions<any, import("@apollo/client").OperationVariables, import("@apollo/client").DefaultContext, import("@apollo/client").ApolloCache<any>> | undefined) => Promise<import("@apollo/client").FetchResult<any>>;
    result: any;
    loading: boolean;
    error: import("@apollo/client").ApolloError | undefined;
};
...
export declare function useDeleteRoute(): {
    deleteRoute: (options?: import("@apollo/client").MutationFunctionOptions<any, import("@apollo/client").OperationVariables, import("@apollo/client").DefaultContext, import("@apollo/client").ApolloCache<any>> | undefined) => Promise<import("@apollo/client").FetchResult<any>>;
    result: any;
    loading: boolean;
    error: import("@apollo/client").ApolloError | undefined;
};
