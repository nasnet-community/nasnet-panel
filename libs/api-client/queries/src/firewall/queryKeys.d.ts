...
export declare const firewallConnectionKeys: {
  ...
  ) => readonly ['firewall', 'connections', string, 'list', ConnectionFilters | undefined];
  byId: (
    routerId: string,
    connectionId: string
  ) => readonly ['firewall', 'connections', string, string];
...
export declare const firewallTemplateKeys: {
  ...
  list: (filters?: { category?: string; complexity?: string }) => readonly [
    'firewall',
    'templates',
    'list',
    (
  ...
  ) => readonly ['firewall', 'templates', 'preview', string, string, Record<string, string>];
