...
export declare const addressListKeys: {
    ...
    entries: (routerId: string, listName: string) => readonly ["addressLists", "entries", string, string];
    entriesPaginated: (routerId: string, listName: string, cursor?: string) => readonly ["addressLists", "entries", string, string, {
...
export declare function useAddressLists(routerId: string, options?: UseAddressListsOptions): UseQueryResult<AddressList[], Error>;
/**
...
export declare function useAddressListEntries(routerId: string, listName: string, options?: UseAddressListEntriesOptions): UseQueryResult<AddressListEntriesConnection, Error>;
/**
 ...
 */
export declare function useCreateAddressListEntry(routerId: string): import("@tanstack/react-query").UseMutationResult<AddressListEntry, Error, CreateAddressListEntryInput, unknown>;
/**
...
export declare function useDeleteAddressListEntry(routerId: string): import("@tanstack/react-query").UseMutationResult<boolean, Error, DeleteAddressListEntryVariables, unknown>;
/**
...
export declare function useBulkCreateAddressListEntries(routerId: string): import("@tanstack/react-query").UseMutationResult<BulkCreateResult, Error, BulkCreateAddressListEntriesVariables, unknown>;
export {};
