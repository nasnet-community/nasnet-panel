 ...
 */
import type { PortKnockSequence, PortKnockSequenceInput, PortKnockAttempt } from '@nasnet/core/types';
/**
...
export declare const portKnockKeys: {
    ...
    log: (routerId: string, filters?: Record<string, unknown>) => readonly ["portKnocking", string, "log", Record<string, unknown> | undefined];
};
/**
 * Get all port knock sequences for a router
 */
export declare function usePortKnockSequences(routerId: string): import("@apollo/client").InteropQueryResult<{
    portKnockSequences: PortKnockSequence[];
}, import("@apollo/client").OperationVariables>;
/**
 * Get single port knock sequence by ID
 */
export declare function usePortKnockSequence(routerId: string, id: string): import("@apollo/client").InteropQueryResult<{
    portKnockSequence: PortKnockSequence | null;
}, import("@apollo/client").OperationVariables>;
/**
 * Get port knock attempt log with infinite scroll
 */
export declare function usePortKnockLog(routerId: string, filters?: {
    status?: string;
    sourceIP?: string;
    sequenceId?: string;
    startDate?: string;
    endDate?: string;
}): import("@tanstack/react-query").UseInfiniteQueryResult<import("@tanstack/query-core").InfiniteData<{
