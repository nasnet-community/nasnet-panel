      ...
      if (input.type === 'server') {
        ...
        return {
          ...
          body: {
            ...
            disabled: data.isDisabled ? 'yes' : 'no',
      ...
      if (input.type === 'server') {
        ...
        return {
          ...
          body: {
            ...
            'require-client-certificate': data.shouldRequireClientCertificate ? 'yes' : 'no',
            auth: data.auth || 'sha1',
        ...
        return {
          ...
          body: {
            ...
            certificate: data.certificate,
            'verify-server-certificate': data.shouldVerifyCertificate ? 'yes' : 'no',
            auth: data.auth || 'sha1',
            cipher: data.cipher || 'aes256-cbc',
            'add-default-route': data.shouldAddDefaultRoute ? 'yes' : 'no',
            disabled: data.isDisabled ? 'yes' : 'no',
            comment: data.comment,
          },
        };
    ...
    case 'l2tp': {
      ...
      return {
        ...
        body: {
          ...
          'add-default-route': data.shouldAddDefaultRoute ? 'yes' : 'no',
          'use-ipsec': data.shouldUseIpsec ? 'yes' : 'no',
