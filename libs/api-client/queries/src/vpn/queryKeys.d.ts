...
export declare const vpnKeys: {
    ...
    trafficHistory: (routerIp: string, protocol?: string) => readonly ["vpn", "traffic", string, string];
    ...
    wireguardPeers: (routerIp: string, interfaceName?: string) => readonly ["vpn", "wireguard", string, "peers", string];
