 ...
 */
export declare enum TroubleshootStepType {
    WAN = "WAN",
    GATEWAY = "GATEWAY",
    INTERNET = "INTERNET",
    DNS = "DNS",
 ...
 */
export declare enum TroubleshootStepStatus {
    PENDING = "PENDING",
    RUNNING = "RUNNING",
    PASSED = "PASSED",
    FAILED = "FAILED",
 ...
 */
export declare enum FixConfidence {
    HIGH = "HIGH",
    MEDIUM = "MEDIUM",
    LOW = "LOW"
}
 ...
 */
export declare enum FixApplicationStatus {
    AVAILABLE = "AVAILABLE",
    APPLYING = "APPLYING",
    APPLIED = "APPLIED",
    FAILED = "FAILED",
 ...
 */
export declare enum TroubleshootSessionStatus {
    IDLE = "IDLE",
