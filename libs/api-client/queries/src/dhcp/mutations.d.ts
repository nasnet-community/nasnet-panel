 ...
 */
export declare function useCreateDHCPServer(
  routerIp: string
): import('@tanstack/react-query').UseMutationResult<
  CreateDHCPServerResult,
  Error,
  CreateDHCPServerInput,
  unknown
>;
/**
 * Hook for updating DHCP server settings
 */
export declare function useUpdateDHCPServer(
  routerIp: string
): import('@tanstack/react-query').UseMutationResult<void, Error, UpdateDHCPServerInput, unknown>;
/**
 * Hook for deleting DHCP servers
 */
export declare function useDeleteDHCPServer(
  routerIp: string
): import('@tanstack/react-query').UseMutationResult<void, Error, string, unknown>;
/**
 * Hook for enabling DHCP servers
 */
export declare function useEnableDHCPServer(
  routerIp: string
): import('@tanstack/react-query').UseMutationResult<void, Error, string, unknown>;
/**
 * Hook for disabling DHCP servers
 */
export declare function useDisableDHCPServer(
  routerIp: string
): import('@tanstack/react-query').UseMutationResult<void, Error, string, unknown>;
/**
 * Hook for converting leases to static bindings
 */
export declare function useMakeLeaseStatic(
  routerIp: string
): import('@tanstack/react-query').UseMutationResult<void, Error, MakeLeaseStaticInput, unknown>;
/**
 * Hook for deleting DHCP leases
 */
export declare function useDeleteLease(
  routerIp: string
): import('@tanstack/react-query').UseMutationResult<void, Error, string, unknown>;
export {};
