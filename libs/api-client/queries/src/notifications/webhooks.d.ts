 ...
 */
export declare function useWebhook(
  id: string,
  options?: QueryHookOptions<
    {
...
export declare function useNotificationLogs(
 ...
 * Create a new webhook
 */
export declare function useCreateWebhook(
 ...
 * Update an existing webhook
 */
export declare function useUpdateWebhook(
  options?: MutationHookOptions<
    {
      updateWebhook: {
        webhook: Webhook | null;
 ...
 * Delete a webhook
 */
export declare function useDeleteWebhook(
  options?: MutationHookOptions<
    {
      deleteWebhook: {
        success: boolean;
 ...
 * Test a webhook by sending a test notification
 */
export declare function useTestWebhook(
  options?: MutationHookOptions<
    {
      testWebhook: {
