 ...
 * ```
 */
export declare function useResourceList<TConfig = unknown>(
  options?: UseResourceListOptions
): UseResourceListResult<TConfig>;
/**
 * Hook for fetching resources by category.
 */
export declare function useResourcesByCategory<TConfig = unknown>(
  routerId: string,
  category: ResourceCategory,
 ...
 */
export declare function useResourcesByType<TConfig = unknown>(
  routerId: string,
  type: string,
  options?: Omit<UseResourceListOptions, 'filter'>
): UseResourceListResult<TConfig>;
 ...
 */
export declare function useFavoriteResources<TConfig = unknown>(
  routerId: string,
  options?: Omit<UseResourceListOptions, 'filter'>
): UseResourceListResult<TConfig>;
/**
 ...
 */
export declare function useResourcesWithErrors<TConfig = unknown>(
  routerId: string,
  options?: Omit<UseResourceListOptions, 'filter'>
): UseResourceListResult<TConfig>;
/**
 ...
 */
export declare function useResourceSearch<TConfig = unknown>(
  routerId: string,
  searchQuery: string,
  options?: Omit<UseResourceListOptions, 'filter'>
): UseResourceListResult<TConfig>;
