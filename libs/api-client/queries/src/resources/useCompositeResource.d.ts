 ...
 * ```
 */
export declare function useCompositeResource(
 ...
 */
export declare function useWireGuardServerWithClients(
 ...
 */
export declare function useLANNetworkWithDHCP(
 ...
 */
export declare function useBridgeWithMembers(
 ...
 */
export declare function useFeatureWithResources(
