 ...
 * ```
 */
export declare function useResource<TConfig = unknown>(
 ...
 */
export declare function useResourceDetail<TConfig = unknown>(
  uuid: string | undefined,
 ...
 */
export declare function useResourceFull<TConfig = unknown>(
  uuid: string | undefined,
  options?: Omit<UseResourceOptions, 'layers'>
): UseResourceResult<TConfig>;
/**
 ...
 */
export declare function useResourceCard<TConfig = unknown>(
  uuid: string | undefined,
  options?: Omit<UseResourceOptions, 'layers'>
): UseResourceResult<TConfig>;
