 ...
 * ```
 */
export declare function makeRouterOSRequest<T>(routerIp: string, endpoint: string, options?: RouterOSRequestOptions, config?: Partial<ProxyConfig>): Promise<RouterOSResponse<T>>;
/**
 ...
 * ```
 */
export declare function createProxyQueryFn<T>(routerIp: string, endpoint: string, options?: RouterOSRequestOptions): () => Promise<T>;
/**
 ...
 */
export declare function createProxyMutationFn<TData, TVariables>(routerIp: string, endpoint: string, method?: 'POST' | 'PUT' | 'PATCH' | 'DELETE'): (variables: TVariables) => Promise<TData>;
export {};
