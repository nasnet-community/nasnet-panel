 ...
 */
export declare const DNS_RECORD_TYPES: readonly ["A", "AAAA", "MX", "TXT", "CNAME", "NS", "PTR", "SOA", "SRV"];
 ...
 */
export type DnsLookupStatus = 'SUCCESS' | 'NXDOMAIN' | 'SERVFAIL' | 'TIMEOUT' | 'REFUSED' | 'NETWORK_ERROR';
/**
...
//# sourceMappingURL=DnsLookupTool.types.d.ts.map