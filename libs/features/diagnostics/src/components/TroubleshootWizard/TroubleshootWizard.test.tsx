...
describe('TroubleshootWizard', () => {
      ...
      const mockWizard = createMockWizard({
        ...
        currentStep: {
          ...
          fix: {
            ...
            explanation: 'Your WAN interface is disabled. Enable it to restore connectivity.',
      ...
      const mockWizard = createMockWizard({
        ...
        currentStep: {
          ...
          fix: {
            issueCode: 'WAN_DISABLED',
            title: 'Enable WAN Interface',
            explanation: 'Your WAN interface is disabled.',
            command: '/interface/enable [find name=ether1]',
        ...
        steps: [
          {
            ...
            description: 'Checking WAN interface status',
            status: 'passed',
            result: { success: true, message: 'WAN interface is running', issueCode: null, executionTimeMs: 100 },
            fix: null,
          },
          {
            id: 'gateway',
            ...
            description: 'Testing gateway reachability',
            status: 'passed',
            result: { success: true, message: 'Gateway is reachable', issueCode: null, executionTimeMs: 200 },
            fix: null,
          },
          {
            id: 'internet',
            ...
            description: 'Testing internet connection',
            status: 'passed',
            result: { success: true, message: 'Internet is reachable', issueCode: null, executionTimeMs: 300 },
            fix: null,
          },
          {
            id: 'dns',
            ...
            description: 'Testing DNS resolution',
            status: 'passed',
            result: { success: true, message: 'DNS is working', issueCode: null, executionTimeMs: 150 },
            fix: null,
          },
          {
            id: 'nat',
            ...
            description: 'Verifying NAT rules',
            status: 'passed',
            result: { success: true, message: 'NAT is configured', issueCode: null, executionTimeMs: 100 },
            fix: null,
          },
        ],
      });
      ...
      const mockWizard = createMockWizard({
        ...
        currentStep: {
          ...
          fix: {
            issueCode: 'NO_INTERNET',
            title: 'Contact ISP',
            explanation: 'No internet connection detected.',
            command: '',
            rollbackCommand: null,
            confidence: 'low',
            requiresConfirmation: false,
  ...
  describe('Accessibility', () => {
    it('should have proper heading hierarchy', () => {
      ...
      const heading = screen.getByRole('heading', { name: /no internet troubleshooting/i });
    ...
    it('should have accessible button labels', () => {
      ...
      const closeButton = screen.getByRole('button', { name: /close troubleshooting wizard/i });
      expect(closeButton).toHaveAttribute('aria-label', 'Close troubleshooting wizard');
    });
    ...
    it('should announce step progress to screen readers', () => {
      ...
      // StepAnnouncer should be present (check for aria-live region)
      expect(screen.getByText(/step 3 of 5/i)).toBeInTheDocument();
    });
