 ...
 */
export declare const HOP_PROBE_FRAGMENT: import("graphql").DocumentNode;
/**
 ...
 */
export declare const TRACEROUTE_HOP_FRAGMENT: import("graphql").DocumentNode;
/**
 ...
 */
export declare const TRACEROUTE_RESULT_FRAGMENT: import("graphql").DocumentNode;
/**
 ...
 * ```
 */
export declare const RUN_TRACEROUTE: import("graphql").DocumentNode;
/**
 ...
 * ```
 */
export declare const CANCEL_TRACEROUTE: import("graphql").DocumentNode;
/**
 ...
 * ```
 */
export declare const TRACEROUTE_PROGRESS_SUBSCRIPTION: import("graphql").DocumentNode;
//# sourceMappingURL=traceroute.graphql.d.ts.map