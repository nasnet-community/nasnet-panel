        ...
        >
          <div className="space-y-component-md pb-20">
            ...
            <div className="space-y-component-sm">
              ...
              <p className="text-muted-foreground text-sm">Unique name for the VLAN interface</p>
            </div>
            ...
            <div className="space-y-component-sm">
              ...
              <div className="relative">
                <Input
                  ...
                  aria-describedby={errors.vlanId ? 'vlanId-error-mobile' : undefined}
                />
                {checkingDuplicate && (
            ...
            <div className="space-y-component-sm">
              ...
              <InterfaceSelector
                ...
                aria-describedby={errors.interface ? 'interface-error-mobile' : undefined}
              />
              {errors.interface && (
                <p
                  id="interface-error-mobile"
                  className="text-error text-sm"
                >
            ...
            <div className="space-y-component-sm">
              ...
              <Textarea
                ...
                aria-describedby={errors.comment ? 'comment-error-mobile' : undefined}
              />
              {errors.comment && (
                <p
                  id="comment-error-mobile"
                  className="text-error text-sm"
                >
            ...
            {/* Disabled Toggle */}
            <div className="border-border p-component-md flex items-center justify-between rounded-[var(--semantic-radius-card)] border">
              <div className="flex-1 space-y-1">
                <Label htmlFor="disabled-mobile">Disabled</Label>
                <p className="text-muted-foreground text-sm">Administratively disable this VLAN</p>
              </div>
              <Switch
                id="disabled-mobile"
            ...
            {mode === 'create' && (
              ...
              >
                ...
                <AlertDescription className="text-sm">
                  Creating a VLAN interface adds an 802.1Q VLAN tag to traffic. Configure bridge
                  ports to use this VLAN.
                </AlertDescription>
              </Alert>
            )}
          </div>
          ...
          <SheetFooter className="p-component-md bg-background border-border gap-component-md fixed bottom-0 left-0 right-0 flex-row border-t">
            <Button
              type="button"
              variant="outline"
              onClick={onCancel}
