...
export const LargeList: Story = {
  args: {
    entries: [
      ...
      { '.id': '*3', name: 'cam-01.local', address: '10.10.0.3', ttl: '3600', comment: 'Front door camera', disabled: false },
      { '.id': '*4', name: 'cam-02.local', address: '10.10.0.4', ttl: '3600', comment: 'Garage camera', disabled: false },
      { '.id': '*5', name: 'delta.lan', address: '10.10.0.5', ttl: '86400', disabled: false },
      { '.id': '*6', name: 'files.local', address: '10.10.0.6', ttl: '604800', comment: 'File server', disabled: false },
      { '.id': '*7', name: 'gateway.lan', address: '10.10.0.254', ttl: '604800', comment: 'Main router', disabled: false },
      { '.id': '*8', name: 'media.local', address: '10.10.0.8', ttl: '86400', comment: 'Plex server', disabled: false },
      { '.id': '*9', name: 'nas.local', address: '10.10.0.9', ttl: '86400', comment: 'Synology NAS', disabled: false },
      { '.id': '*10', name: 'printer.local', address: '10.10.0.10', ttl: '3600', comment: 'HP LaserJet', disabled: false },
    ],
  },
  parameters: {
    docs: {
