      ...
      <CardContent className="space-y-4">
        ...
        {hasStorage && (
          <div className="space-y-2">
            ...
            <Select defaultValue="/mnt/usb1" disabled={configuring}>
...
export const NotConfigured: Story = {
  render: () => (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <MockConfigCard status="unconfigured" hasStorage />
      <MockUsageCard externalPercent={0} flashPercent={48} />
    </div>
  ),
};
...
export const ConfiguredAndConnected: Story = {
  render: () => (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <MockConfigCard status="configured" hasStorage />
      <MockUsageCard externalPercent={55} flashPercent={30} />
    </div>
  ),
};
...
export const Disconnected: Story = {
  render: () => (
    <div className="space-y-4">
      <div className="rounded-lg border border-warning bg-warning/10 p-4 flex items-start gap-3 text-warning-foreground">
        <AlertTriangle className="h-5 w-5 mt-0.5 shrink-0" />
        <div>
          <p className="font-semibold">External Storage Disconnected</p>
          <p className="text-sm mt-1">
            Storage at <code className="bg-muted rounded px-1">/mnt/usb1</code> is no
            longer available. Services using external storage may be unavailable.
          </p>
        </div>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <MockConfigCard status="disconnected" hasStorage={false} />
        <MockUsageCard externalPercent={0} flashPercent={78} />
      </div>
    </div>
  ),
};
...
export const NoHardwareDetected: Story = {
  render: () => (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <MockConfigCard status="unconfigured" hasStorage={false} />
      <MockUsageCard externalPercent={0} flashPercent={65} />
    </div>
  ),
};
...
export const Scanning: Story = {
  render: () => (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <MockConfigCard status="unconfigured" hasStorage scanning />
      <MockUsageCard externalPercent={0} flashPercent={52} />
    </div>
  ),
};
...
export const FlashWarning: Story = {
  render: () => (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <MockConfigCard status="configured" hasStorage />
      <MockUsageCard externalPercent={42} flashPercent={87} />
    </div>
  ),
};
