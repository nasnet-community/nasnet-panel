 ...
 * ```
 */
declare function ServiceTrafficPanelComponent(props: ServiceTrafficPanelProps): import("react/jsx-runtime").JSX.Element;
export declare const ServiceTrafficPanel: import("react").MemoExoticComponent<typeof ServiceTrafficPanelComponent>;
export { ServiceTrafficPanelDesktop, ServiceTrafficPanelMobile };
export type { ServiceTrafficPanelProps };
//# sourceMappingURL=ServiceTrafficPanel.d.ts.map