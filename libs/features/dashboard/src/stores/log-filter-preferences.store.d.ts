 ...
 * ```
 */
export declare const useLogFilterPreferencesStore: import("zustand").UseBoundStore<Omit<import("zustand").StoreApi<LogFilterPreferencesState>, "persist"> & {
    persist: {
        setOptions: (options: Partial<import("zustand/middleware").PersistOptions<LogFilterPreferencesState, LogFilterPreferencesState>>) => void;
        clearStorage: () => void;
        rehydrate: () => Promise<void> | void;
        hasHydrated: () => boolean;
        onHydrate: (fn: (state: LogFilterPreferencesState) => void) => () => void;
        onFinishHydration: (fn: (state: LogFilterPreferencesState) => void) => () => void;
        getOptions: () => Partial<import("zustand/middleware").PersistOptions<LogFilterPreferencesState, LogFilterPreferencesState>>;
    };
}>;
export {};
//# sourceMappingURL=log-filter-preferences.store.d.ts.map