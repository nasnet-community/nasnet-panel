 ...
 */
export const InterfaceGridDesktop = memo(function InterfaceGridDesktop({
  deviceId,
  className,
}: InterfaceGridProps) {
  ...
  if (isLoading) {
    return (
      <div
        className={cn('gap-component-md grid grid-cols-4', className)}
        role="status"
  ...
  return (
    <div className={className}>
      ...
      <div
        className="gap-component-md grid grid-cols-4"
        role="list"
