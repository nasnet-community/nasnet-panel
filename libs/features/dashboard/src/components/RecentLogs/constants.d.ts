 ...
 */
export declare const SEVERITY_CONFIG: Record<LogSeverity, {
 ...
 */
export declare const TOPIC_LABELS: Record<LogTopic, string>;
/**
 ...
 */
export declare const TOPIC_ICONS: Partial<Record<LogTopic, LucideIcon>> & {
    default: LucideIcon;
};
/**
 ...
 */
export declare const ALL_FILTER_TOPICS: LogTopic[];
/**
 ...
 */
export declare const MAX_VISIBLE_LOGS = 10;
/**
