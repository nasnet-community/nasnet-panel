      ...
      handlers: [
        {
          ...
          response: {
            data: [
              { id: '*1', chain: 'input', action: 'accept', disabled: false, order: 0, connectionState: ['established', 'related'] },
              { id: '*2', chain: 'input', action: 'accept', disabled: false, order: 1, protocol: 'tcp', dstPort: '22', srcAddress: '192.168.88.0/24' },
              { id: '*3', chain: 'input', action: 'drop', disabled: false, order: 2, comment: 'Drop all other input' },
              { id: '*4', chain: 'forward', action: 'accept', disabled: false, order: 3, connectionState: ['established', 'related'] },
              { id: '*5', chain: 'forward', action: 'drop', disabled: false, order: 4, comment: 'Drop invalid' },
            ],
          },
        },
        {
          ...
          response: {
            data: [
              { id: '*1', chain: 'srcnat', action: 'masquerade', disabled: false, order: 0, outInterface: 'ether1', comment: 'Masquerade' },
              { id: '*2', chain: 'dstnat', action: 'dst-nat', disabled: false, order: 1, protocol: 'tcp', dstPort: '80', toAddresses: '192.168.1.100', toPorts: '8080' },
            ],
          },
        },
      ],
      ...
      handlers: [
        {
          ...
          response: {
            data: [
              { id: '*1', chain: 'input', action: 'accept', disabled: false, order: 0, comment: 'Accept all — no drop rules' },
              { id: '*2', chain: 'forward', action: 'accept', disabled: false, order: 1, connectionState: ['established', 'related'] },
              { id: '*3', chain: 'forward', action: 'log', disabled: false, order: 2, comment: 'Log only, no drops' },
            ],
          },
        },
        {
