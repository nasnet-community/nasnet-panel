...
Complete reference for all utility functions exported from `@nasnet/core/utils`. This library provides network validation, data formatting, React hooks, dependency graph algorithms, log export, and device detection utilities.
...
**Parameters:**
- `mac`: MAC address string (any format: `XX:XX:XX:XX:XX:XX`, `XX-XX-XX-XX-XX-XX`, or `XXXXXXXXXXXX`)
...
**Validation:** Regex: `/^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])$/`
...
parseFirewallLogMessage(
  "DROPPED-WAN input: in:ether1, proto ICMP, 8.8.8.8->192.168.1.1"
)
// {
//   chain: 'input',
//   action: 'drop',
...
The library exports Zod validation schemas for runtime validation. These are located in `libs/core/utils/src/validation/index.d.ts` and include:
...
- Formatters: `formatters/formatters.test.ts`, `formatters/leaseTime.test.ts`, `formatters/timestamp.test.ts`
- Network: `network/ip.test.ts`, `network/subnet.test.ts`
- Hooks: `hooks/useRelativeTime.test.ts`, `hooks/useAutoScroll.test.ts`, `hooks/useReducedMotion.test.ts`
