...
export function useZodForm<T extends ZodSchema>(
  ...
  return useForm<z.infer<T>>({
    // Note: zodResolver has type constraints that require schema type casting.
    // This is a known limitation of the @hookform/resolvers library and is safe here
    // because we validate the schema type through UseZodFormOptions<T extends ZodSchema>.
