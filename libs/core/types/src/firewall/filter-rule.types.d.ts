 ...
 */
export declare const FilterActionSchema: z.ZodEnum<
  ['accept', 'drop', 'reject', 'log', 'jump', 'tarpit', 'passthrough']
>;
 ...
 */
export declare const FilterRuleSchema: z.ZodEffects<
  z.ZodEffects<
    z.ZodEffects<
      z.ZodEffects<
        z.ZodObject<
          {
            ...
            connectionState: z.ZodOptional<
              z.ZodArray<
                z.ZodEnum<['established', 'new', 'related', 'invalid', 'untracked']>,
                'many'
              >
            >;
