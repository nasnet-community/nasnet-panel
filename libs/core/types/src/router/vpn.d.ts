 ...
 * ```
 */
export type VPNServerType = WireGuardServer | OpenVPNServer | L2TPServer | PPTPServer | SSTPServer | IKEv2Server;
/**
 ...
 * ```
 */
export type VPNClientType = WireGuardClient | OpenVPNClient | L2TPClient | PPTPClient | SSTPClient | IKEv2Client;
/**
 ...
 */
export type VPNConfig = WireGuardInterface | OpenVPNConfig | L2TPConfig | PPTPConfig | SSSTPConfig | IKEv2Config;
/**
