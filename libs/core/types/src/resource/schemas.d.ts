 ...
 */
export declare const ResourceCategorySchema: z.ZodEnum<["NETWORK", "VPN", "INFRASTRUCTURE", "APPLICATION", "FEATURE", "PLUGIN"]>;
/**
 ...
 */
export declare const ResourceLifecycleStateSchema: z.ZodEnum<["DRAFT", "VALIDATING", "VALID", "APPLYING", "ACTIVE", "DEGRADED", "ERROR", "DEPRECATED", "ARCHIVED"]>;
/**
 * Resource layer enumeration schema.
 * Identifies the 8 layers of the Universal State v2 model.
 */
export declare const ResourceLayerSchema: z.ZodEnum<["CONFIGURATION", "VALIDATION", "DEPLOYMENT", "RUNTIME", "TELEMETRY", "METADATA", "RELATIONSHIPS", "PLATFORM"]>;
/**
 * Validation stage enumeration schema.
 * Defines the progression of validation checks through multiple stages.
 */
export declare const ValidationStageSchema: z.ZodEnum<["SCHEMA", "SEMANTIC", "DEPENDENCY", "CONFLICT", "PLATFORM", "QUOTA", "SIMULATION", "COMPLETE"]>;
/**
 ...
 */
export declare const ConflictTypeSchema: z.ZodEnum<["PORT", "IP_ADDRESS", "ROUTE", "INTERFACE", "NAME", "CONFIGURATION"]>;
/**
 ...
 */
export declare const RuntimeHealthSchema: z.ZodEnum<["HEALTHY", "WARNING", "DEGRADED", "FAILED", "UNKNOWN"]>;
/**
 ...
 */
export declare const ResourceRelationshipTypeSchema: z.ZodEnum<["DEPENDS_ON", "ROUTES_VIA", "PARENT_CHILD", "GROUP", "CUSTOM"]>;
/**
...
export declare const ValidationResultSchema: z.ZodObject<{
    ...
    stage: z.ZodEnum<["SCHEMA", "SEMANTIC", "DEPENDENCY", "CONFLICT", "PLATFORM", "QUOTA", "SIMULATION", "COMPLETE"]>;
    ...
    requiredDependencies: z.ZodArray<z.ZodObject<{
        resourceUuid: z.ZodString;
        resourceType: z.ZodString;
        isActive: z.ZodBoolean;
        state: z.ZodEnum<["DRAFT", "VALIDATING", "VALID", "APPLYING", "ACTIVE", "DEGRADED", "ERROR", "DEPRECATED", "ARCHIVED"]>;
...
export declare const DriftInfoSchema: z.ZodObject<{
    ...
    driftedFields: z.ZodArray<z.ZodObject<{
        path: z.ZodString;
        expected: z.ZodUnknown;
        actual: z.ZodUnknown;
    }, "strip", z.ZodTypeAny, {
...
export declare const DeploymentStateSchema: z.ZodObject<{
    ...
    drift: z.ZodOptional<z.ZodNullable<z.ZodObject<{
        detectedAt: z.ZodString;
        driftedFields: z.ZodArray<z.ZodObject<{
            path: z.ZodString;
            expected: z.ZodUnknown;
...
export declare const TelemetryDataSchema: z.ZodObject<{
    ...
    hourlyStats: z.ZodOptional<z.ZodNullable<z.ZodArray<z.ZodObject<{
        hour: z.ZodString;
        totalBytesIn: z.ZodNumber;
        totalBytesOut: z.ZodNumber;
        uptimePercent: z.ZodNumber;
    ...
    dailyStats: z.ZodOptional<z.ZodNullable<z.ZodArray<z.ZodObject<{
        date: z.ZodString;
        totalBytesIn: z.ZodNumber;
        totalBytesOut: z.ZodNumber;
        uptimePercent: z.ZodNumber;
...
export declare const ResourceMetadataSchema: z.ZodObject<{
    ...
    recentChanges: z.ZodOptional<z.ZodNullable<z.ZodArray<z.ZodObject<{
        timestamp: z.ZodString;
        user: z.ZodString;
        changeType: z.ZodEnum<["CREATE", "UPDATE", "DELETE"]>;
        changedFields: z.ZodArray<z.ZodString, "many">;
...
export declare const PlatformInfoSchema: z.ZodObject<{
    ...
    features: z.ZodOptional<z.ZodNullable<z.ZodArray<z.ZodObject<{
        id: z.ZodString;
        name: z.ZodString;
        enabled: z.ZodBoolean;
        description: z.ZodOptional<z.ZodNullable<z.ZodString>>;
