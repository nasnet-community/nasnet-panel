 ...
 * Provides formatting functions for dates, numbers, and data sizes
 */
...
/**
 * Formats seconds/milliseconds as a duration string
...
/**
 * Formats bytes per second (bandwidth)
 ...
 * @returns Truncated public key string
 * @example
 * formatPublicKey("ABC123XYZ789DEFGHI456") // "ABC123XY...I456"
 * formatPublicKey("SHORT") // "SHORT" (too short to truncate)
 * formatPublicKey("") // "" (empty string)
 */
