...
export const WELL_KNOWN_PORTS: WellKnownPort[] = [
  ...
  },
  {
    ...
    protocol: 'tcp',
    category: 'web',
    description: 'Common development server',
    builtIn: true,
  },
  {
    port: 4000,
  ...
  },
  {
    ...
    protocol: 'tcp',
    category: 'secure',
    description: 'Telnet (unencrypted)',
    builtIn: true,
  },
  {
    port: 3389,
  ...
  },
  {
    ...
    protocol: 'tcp',
    category: 'mail',
    description: 'Development mail server',
    builtIn: true,
  },
  {
    port: 3025,
  ...
  {
    port: 30000,
    service: 'K8s-NodePort',
    protocol: 'tcp',
    category: 'containers',
    description: 'K8s NodePort start',
    builtIn: true,
  },
  {
    port: 32767,
  ...
  },
  {
    ...
    protocol: 'tcp',
    category: 'containers',
    description: 'Alternative Docker',
    builtIn: true,
  },
  {
    port: 2380,
  ...
  {
    port: 2000,
    service: 'Bandwidth-Test',
    protocol: 'tcp',
    category: 'mikrotik',
    description: 'MikroTik Bandwidth Test',
    builtIn: true,
  },
  {
    port: 20561,
    ...
    protocol: 'udp',
    category: 'mikrotik',
    description: 'MikroTik MAC Winbox',
    builtIn: true,
  },
];
...
export function getPortEntry(port: number, protocol?: PortProtocol): WellKnownPort | null {
  ...
  return protocolMap.get('tcp') || protocolMap.get('udp') || protocolMap.get('both') || null;
}
...
export function searchPorts(query: string, limit = 10): WellKnownPort[] {
  ...
  WELL_KNOWN_PORTS.forEach((entry) => {
    ...
    } else if (serviceLower.includes(normalizedQuery) || descLower.includes(normalizedQuery)) {
